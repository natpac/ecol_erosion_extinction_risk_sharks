...
Time-series and trait data are publicly available on https://www.sharkipedia.org/ (Mull, C. G., Pacoureau, N., Pardo, S. A., Ruiz, L. S., García-Rodríguez, E., Finucci, B., ... & Dulvy, N. K. (2022). Sharkipedia: a curated open access database of shark and ray life history traits and abundance time-series. Scientific Data, 9(1), 559.)
...
Global_Chondrichthyan_Catch_and_Effort is the folder for the catch reconstructions and fishing effort analysis. It contains:
